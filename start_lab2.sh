...
spark-submit --class bdtc.lab2.SparkRDDApplication --master local --deploy-mode client --executor-memory 1g --name newstypecount --conf "spark.app.id=SparkRDDApplication"  target/lab2-1.0-SNAPSHOT-jar-with-dependencies.jar hdfs://127.0.0.1:9000/user/dm/records/ out
